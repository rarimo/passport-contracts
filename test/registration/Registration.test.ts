...
import { RegistrationMock, VerifierMock, RegistrationVerifier } from "@ethers-v6";
...
describe("Registration", () => {
  ...
  describe("#init", () => {
    it("should not initialize twice", async () => {
      ...
      expect(
        registration.__Registration_init(TREE_SIZE, await registrationVerifier.getAddress(), icaoMerkleRoot),
