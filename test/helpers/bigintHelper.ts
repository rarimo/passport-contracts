...
export const lowSmax = BigInt(
  "0x7fffffffffffffffffffffffffffffffffffffffffffffffe3b1a6c0fa1b96efac0d06d9245853bd76760cb5666294b9",
);
...
export function toAffinePoint(x0: bigint, y0: bigint, z0: bigint): { x: bigint; y: bigint } {
  ...
  const x = moddiv(x0, z0, p);
  const y = modiv(y0, z0, p);
