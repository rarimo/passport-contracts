...
describe("PECDSAAuthenticator", () => {
  ...
  describe("#authenticate", () => {
    ...
    it.only("should authenticate passport - secp384r1 & sha2 new", async () => {
      ...
      const r = "0x" + "3044b552135e5eb46368e739b3138f9f1f2eb37a0518f564d2767d02ac67a9f41fb71bad06a99f54ee2e43ead2916f63".padStart(128, "0");
      const s = "0x" + "f1f85ce14adeb8671a134fcd1b6a7a0a2c2ad4908b27428dcb65ed17afd07f6524a7d892015394132b48bb3a2bdd1edd".padStart(128, "0");
      const x = "0x" + "56931fd7d42942eec92298d7291371cdbac29c60230c9f635d010939ab7f8f5d977ccfe90bd7528cafa53afad6225bf6".padStart(128, "0");
      const y = "0x" + "1e2af4d20831aed1e6b578ccb00e1534182f6d1ee6bf524fbd62bd056d0d538c24eb7f2a436e336e139f00a072b0ba1a".padStart(128, "0");
